...
from ..crud import create_service, get_user_by_service_name
...
@router.post("/", response_model=UserSchemaResponse, status_code=status.HTTP_201_CREATED, response_description="User created successfully")
